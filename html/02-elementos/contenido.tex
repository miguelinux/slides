...
\begin{frame}[c]{Resumen de atributos}
  \begin{itemize}
    \item Todos los elementos HTML pueden tener \textbf{atributos}
    \item El atributo \atri{href} de \eti{<a>} especifica la
          URL de la página a la que va el enlace
    \item El atributo \atri{src} de \eti{<img>} especifica la
          ruta a la imagen que se mostrará
    \item Los atributos \atri{width} y \atri{height} de \eti{<img>}
          proporcionan información sobre el tamaño de las imágenes.
    \item El atributo \atri{alt} de \eti{<img>} proporciona un
          texto alternativo para una imagen
    \item El atributo \atri{style} se usa para agregar estilos a
          un elemento, como color, fuente, tamaño y más
    \item El atributo \atri{lang} de la etiqueta \eti{<html>}
          declara el idioma de la página web.
    \item El atributo \atri{title} define alguna información
