...
\begin{frame}[c]{Tipo de datos integrados}
  ...
  \begin{tabular}{ll}
    ...
    \pausa
    Booleano & \textcolor{codeKeyword2}{bool} \\
    \pausa
...
\begin{frame}[fragile]
  ...
  Las funciones \textcolor{codeKeyword2}{min}() y
  \textcolor{codeKeyword2}{max}() se pueden
...
\begin{frame}[fragile]
  ...
  La función \textcolor{codeKeyword2}{abs}() devuelve el
...
\begin{frame}[fragile]
  ...
  La función \textcolor{codeKeyword2}{pow(x, y)} devuelve el valo
