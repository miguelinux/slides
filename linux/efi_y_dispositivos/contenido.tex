...
\begin{frame}[c]{Tabla de particiones tipo MBR o DOS}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw[draw=green!60, fill=green!5, thick] (3.2,0.2) rectangle (5,1.8);
      \draw[draw=magenta!60, fill=magenta!5, thick] (5.2,0.2) rectangle (9.8,1.8);
      \draw[draw=blue!60, fill=blue!5, thick] (5.4,0.4) rectangle (7.4,1.6);
      \draw[draw=blue!60, fill=blue!5, thick] (7.6,0.4) rectangle (9.6,1.6);
      \node at (2.1,1) {\footnotesize{/dev/xxx1}};
      \node at (4.1,1) {\footnotesize{/dev/xxx2}};
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw[draw=blue!60, fill=blue!5, thick] (3.4,0.4) rectangle (5.4,1.6);
      \draw[draw=blue!60, fill=blue!5, thick] (5.6,0.4) rectangle (7.4,1.6);
      \draw[draw=blue!60, fill=blue!5, thick] (7.6,0.4) rectangle (9.6,1.6);
      \node at (2.1,1) {\footnotesize{/dev/xxx1}};
