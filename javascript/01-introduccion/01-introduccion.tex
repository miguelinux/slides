...
\title{Introducción a JavaScript} % The short title appears at the bottom of every slide,
...
\begin{frame}[c]{Créditos}
  ...
  \begin{itemize}
    ...
    \item \href{https://es.wikipedia.org/wiki/JavaScript}{https://es.wikipedia.org/wiki/JavaScript}
  \end{itemize}
\end{frame}
